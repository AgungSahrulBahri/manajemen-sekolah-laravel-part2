    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="tambahForm" action="<?php echo e(Route('guru.store')); ?>" method="POST">
...
<script>
    ...
    $('.table tbody').on('click', '.editModal', function(){
        ...
        var url = '<?php echo e(route("guru.update", ":id")); ?>';
     ...
     $('.table tbody').on('click', '.hapusModal', function(){
      var id = $(this).data('id');
      var url = '<?php echo e(route("guru.destroy", ":id")); ?>';
      url = url.replace(':id', id);
 ...
 <?php /**PATH /home/user1/Dokumen/project-laravel/LaravelPert5/resources/views/teacher/modals.blade.php ENDPATH**/ ?>