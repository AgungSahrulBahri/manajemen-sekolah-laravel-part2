            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <center class="m-t-30"> <img src="<?php echo e(asset('images/users/5.jpg')); ?>" class="img-circle" width="150">
                        ...
                        <h6 class="card-subtitle"><?php echo e($t['nig']); ?></h6>

                        <h6 class="card-subtitle"><?php echo e($t['kodeguru']); ?></h6>
                        ...
                        <?php $__currentLoopData = $t->mapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h6 class="card-subtitle"><?php echo e($m->nama); ?></h6>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user1/Dokumen/project-laravel/LaravelPert5/resources/views/teacher/guru-detail.blade.php ENDPATH**/ ?>